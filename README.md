...
Windowsアプリは[Releases](https://github.com/TKSLOTTY/TKSLOTTY-WaterCoolingDevice/releases)からダウンロードできます。C#ソースコードは[`src/Windows_App`](https://github.com/TKSLOTTY/TKSLOTTY-WaterCoolingDevice/tree/main/src/Windows_App)で公開しており、ライセンス条件の範囲内で用途に合わせたカスタマイズが可能です。
